...
6. $t = -1.34375 > -2.064$, $H_0$ is not rejected, so there is no evidence showing that the average CBF for stroke patients is different from that of healthy people.
