...
### Solution 
Because the points in the normal probability plots are close to the straight line, the data appears to come from a normal distribution population.  
...
### Solution 
Because the points on the plot deviate from a straight line, the data don't come from a normal distribution population. 
...
Since the distribution of data is symmetric, the data appears to come from a normal distribution population.
