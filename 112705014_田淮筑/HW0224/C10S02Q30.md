...
## (b)
<img width="600" alt="Image" src="https://github.com/user-attachments/assets/edf20e0f-5b42-4c97-a8ca-3d46858f6caf" />

### Solution
$$t_{\alpha/2} \Rightarrow t_{20;0.025}=2.086. $$
$$
\bar{x} \pm t_{20; 0.025} \times \frac{s}{\sqrt{n}} = 26.6 \pm 2.086 \times \frac{7.4}{\sqrt{21}} 
$$  
$$\text{Construct 95 confidence interval is (23.23, 29.97)}$$
## (c)
<img width="600" alt="Image" src="https://github.com/user-attachments/assets/b0edc049-2aa1-4c8b-9bb8-7c3918fb2cfe" />

### Solution
The mean showed a significant increase from pretreatment to posttreatment, with a slight further rise at follow-up. This suggests that the treatment may have a positive effect on self-esteem scores.
